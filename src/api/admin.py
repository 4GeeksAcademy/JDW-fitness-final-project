...
from .models import db, Availability, Diseases, Experience, Education, ActivityFrequency, Coach, Client, Availability_client,AvailabilityCoach, Match, Likes
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(AvailabilityCoach, db.session))
